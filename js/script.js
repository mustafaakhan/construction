(function($) {
	...
	if($('.time-countdown').length){  
		...
		$this.countdown(finalDate, function(event) {
			var $this = $(this).html(event.strftime('' + '<div class="counter-column"><span class="count">%D</span>GÜN</div> ' + '<div class="counter-column"><span class="count">%H</span>SAAT</div>  ' + '<div class="counter-column"><span class="count">%M</span>DAKİKA</div>  ' + '<div class="counter-column"><span class="count">%S</span>SANİYE</div>'));
		});
	 });
	}
